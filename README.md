...
> 1. ¿Qué es Visual Studio Code?
    ...
    B. Un editor de entorno de desarrollo de software integrado (IDE).

    C. Un editor de código multiplataforma.
...
> 2. ¿Visual Studio Code es multiplataforma?
    ...
    B. Si, funciona en Windows, Linux, MACos, entre otros.

    C. No, funciona unicamente en Computadores..
...
> 4. ¿Con que lenguajes de programación puedo utilizar VSC?
    ...
    B. Con cualquier lenguaje de programación que sea de desarrollo WEB.

    C. Solo funciona para HTML, CSS, JS, Python, SQL, PHP.
...
> 5. ¿Visual Studio Code se puede personalizar a las necesidades del lenguaje?
    ...
    B. Si, Cuando se instala Python VSC automáticamente se adapta al lenguaje.
...
> 6. ¿Visual Studio Code es open source?
    ...
    B. No, es un producto de Microsoft por lo tanto no es open source.

    C. Si, es un proyecto de código abierto creado por Microsoft.
...
> 7. ¿Visual Studio Code es el editor más popular por los desarrolladores?
    ...
    B. Si, porqué es el que vamos a utilizar ya que es gratis.
...
> 8. ¿Visual Studio Code es gratuito o de pago?
    ...
    B. Es gratis, para estudiantes y docentes.

    C. Es de pago, la licencia vale $200 USD de un único pago.
...
> 9. ¿Visual Studio Code requiere instalación?
    ...
    B. Si, desde el sistema de aplicaciones de desarrollares de Microsoft.

    C. No, viene instalado por defecto en Windows 11.
